...
func init() {
	...
	flag.StringVar(&group, "group1", "consumer2", "Kafka consumer group definition")
	flag.StringVar(&version, "version", "2.1.1", "Kafka cluster version")
	flag.StringVar(&topics, "topics", "test", "Kafka topics to be consumed, as a comma seperated list")
